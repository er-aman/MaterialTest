package com.example.aman.materialtest.pojo;
 ...
 */
// Here we are using date class is so that we can later exact info like
    //Days months and years and we can later sort information based on
    // the movies released this month or last month or the last 10 days.
    // to get the items on the screen when the orientation is changed we
    // use the concept of parcelable.
